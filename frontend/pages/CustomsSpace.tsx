...
const CustomsSpace: React.FC = () => {
                ...
                <div className="space-y-4">
                    {[
                        ...
                        <div key={i} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100 group hover:border-tunisia-red/20 transition-all">
                            ...
                            <div className={`px-3 py-1 rounded-full text-[8px] font-black uppercase ${log.status === 'OK' ? 'bg-emerald-100 text-emerald-600' :
    ...
    const renderVerifier = () => <CaseVerifier />;
                    ...
                    <div className="lg:col-span-2 bg-white p-10 rounded-[3rem] shadow-sm border border-slate-100">
                        ...
                        <div className="space-y-4 text-[11px]">
                            ...
                            <div className="flex justify-between border-b border-slate-50 pb-3">
                                ...
                                <span className={`font-black uppercase tracking-widest px-2 py-0.5 rounded-md ${profileData.statut === 'ACTIF' ? 'text-emerald-600 bg-emerald-50' : 'text-amber-600 bg-amber-50'
                                    }`}>
