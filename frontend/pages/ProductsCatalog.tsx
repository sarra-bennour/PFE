...
//                 Référentiel Master Data - Liste exhaustive de vos articles
//               </p>
//             </div>
//           </div>
...
//         {/* Statistics Bar - Refined */}
//         <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
//           {[
//             { label: 'Référentiel Global', value: MOCK_PRODUCTS.length, color: 'slate', icon: Package },
//             { label: 'Articles Bio/Alim', value: MOCK_PRODUCTS.filter(p => p.type === 'alimentaire').length, color: 'emerald', icon: Apple },
//             { label: 'Articles Industriels', value: MOCK_PRODUCTS.filter(p => p.type === 'industriel').length, color: 'blue', icon: Factory },
//             { label: 'Catégories NGP', value: new Set(MOCK_PRODUCTS.map(p => p.ngpCode)).size, color: 'tunisia-red', icon: Tags },
//           ].map((stat, i) => (
...
//                   <div className="mb-4">
//                     <span className="text-[10px] font-mono font-bold text-tunisia-red bg-red-50 px-2 py-0.5 rounded italic whitespace-nowrap overflow-hidden text-ellipsis block">NGP: {product.ngpCode}</span>
//                   </div>
...
//                         <Globe size={10} className="text-slate-300" /> {product.origin}
//                       </p>
//                     </div>
//                     <div className="space-y-1">
//                       <span className="text-[8px] font-black uppercase tracking-widest text-slate-400">Marque</span>
//                       <p className="text-[10px] font-bold text-slate-700 uppercase flex items-center gap-1.5">
//                         <ShoppingBag size={10} className="text-slate-300" /> {product.brand || 'N/A'}
//                       </p>
//                     </div>
//                   </div>
//                 </div>
...
//                      selectedProduct.type === 'alimentaire' ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-blue-50 text-blue-600 border-blue-100'
//                    }`}>
//                      {selectedProduct.type} Article
//                    </span>
//                    <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest italic">Inscrit le {selectedProduct.dateAdded}</span>
//                 </div>
...
//                         </label>
//                         <p className="text-xl font-black text-slate-900 tracking-tight italic font-mono">Code NGP: {selectedProduct.ngpCode}</p>
//                       </div>
...
//                         </label>
//                         <p className="text-base font-black text-slate-700 uppercase italic tracking-tight">{selectedProduct.origin}</p>
//                       </div>
//                    </div>
...
//                           {selectedProduct.brand || 'SANS MARQUE'}
//                         </p>
//                       </div>
...
//                         </label>
//                         <p className="text-base font-black text-slate-700 uppercase italic tracking-tight">{selectedProduct.state}</p>
//                       </div>
...
//                         </label>
//                         <p className="text-base font-black text-slate-700 uppercase italic tracking-tight">{selectedProduct.annualVolume}</p>
//                       </div>
//                    </div>
//                 </div>

//                 {selectedProduct.type === 'alimentaire' && (
...
//                         </div>
//                         <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
//                            <span className="text-[8px] font-black text-slate-500 uppercase tracking-widest block mb-1">Licence Sanitaire</span>
//                            <span className={`text-[10px] font-black uppercase ${selectedProduct.hasLicense ? 'text-emerald-400' : 'text-slate-500'}`}>
//                               {selectedProduct.hasLicense ? 'VALIDE' : 'NON REQUIS'}
//                            </span>
//                         </div>
//                      </div>
//                   </div>
...
//                      <span className="text-sm font-black text-slate-900 italic tracking-tighter uppercase">Dernière Déclaration: {selectedProduct.lastDeclaration}</span>
//                    </div>
